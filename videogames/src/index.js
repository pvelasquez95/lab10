...
class Games extends React.Component {
    ...
    editGame(newName, newPlatform, newRate, newPhoto, currentlyEditing) {//edit an existing recipe
        let games = this.state.games;
        console.log("editGame "+currentlyEditing);
        console.log("editGame "+games[currentlyEditing]._id);
        games[currentlyEditing] = {_id: games[currentlyEditing]._id, name: newName, platform: newPlatform, rate: newRate, photo: newPhoto };
        var game = {_id: games[currentlyEditing]._id, name: newName, platform: newPlatform, rate: newRate, photo: newPhoto };
    ...
    deleteGame(index) {//delete an existing game
        ...
        console.log(games[index]._id);
        const url = 'http://localhost:3001/api/juegos/'+games[index]._id;
                                ...
                                <div className="box16" >
                                    ...
                                    <div className="box-content">
                                        <ul className="social">
                                            ...
                                            <br />
                                            <span className="post">ID: {game._id}</span>
